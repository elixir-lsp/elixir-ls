# codegen: do not edit
defmodule GenDAP.Requests.ScopesRequest do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request scopes"

    field(:seq, integer(), enforce: true)
    field(:type, String.t(), default: "request")
    field(:command, String.t(), default: "scopes")
    field(:arguments, GenDAP.Structures.ScopesArguments.t(), enforce: true)
  end
...
defmodule GenDAP.Requests.ScopesResponse do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request scopes response"
    ...
    field(:command, String.t(), default: "scopes")
    field(:body, %{required(:scopes) => list(GenDAP.Structures.Scope.t())}, enforce: true)
  end
  ...
  def schematic() do
    schema(__MODULE__, %{
      ...
      :body =>
        map(%{
          {"scopes", :scopes} => list(GenDAP.Structures.Scope.schematic())
        })
    })
  end
end
