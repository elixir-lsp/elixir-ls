# codegen: do not edit
defmodule GenDAP.Requests.LaunchRequest do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request launch"

    field(:seq, integer(), enforce: true)
    field(:type, String.t(), default: "request")
    field(:command, String.t(), default: "launch")
    field(:arguments, GenDAP.Structures.LaunchRequestArguments.t(), enforce: true)
  end
...
defmodule GenDAP.Requests.LaunchResponse do
  @moduledoc """
  A response to the launch request
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request launch response"
