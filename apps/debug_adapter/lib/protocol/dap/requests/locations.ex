...
defmodule GenDAP.Requests.LocationsResponse do
  ...
  * type: Message type.
  ...
  typedstruct do
    ...
    field :command, String.t(), default: "locations"
    field :body, %{required(:line) => integer(), optional(:column) => integer(), required(:source) => GenDAP.Structures.Source.t(), optional(:end_line) => integer(), optional(:end_column) => integer()}
  end
