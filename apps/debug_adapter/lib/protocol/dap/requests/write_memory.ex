# codegen: do not edit
defmodule GenDAP.Requests.WriteMemoryRequest do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request writeMemory"

    field(:seq, integer(), enforce: true)
    field(:type, String.t(), default: "request")
    field(:command, String.t(), default: "writeMemory")
    field(:arguments, GenDAP.Structures.WriteMemoryArguments.t(), enforce: true)
  end
...
defmodule GenDAP.Requests.WriteMemoryResponse do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request writeMemory response"
    ...
    field(:command, String.t(), default: "writeMemory")
    field(:body, %{optional(:offset) => integer(), optional(:bytes_written) => integer()})
  end
    ...
    schema(__MODULE__, %{
      ...
      optional(:body) =>
        map(%{
          ...
          optional({"bytesWritten", :bytes_written}) => int()
        })
    })
  end
end
