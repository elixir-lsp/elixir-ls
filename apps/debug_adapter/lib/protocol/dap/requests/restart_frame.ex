# codegen: do not edit
defmodule GenDAP.Requests.RestartFrameRequest do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request restartFrame"

    field :seq, integer(), enforce: true
    field :type, String.t(), default: "request"
    field :command, String.t(), default: "restartFrame"
    field :arguments, GenDAP.Structures.RestartFrameArguments.t(), enforce: true
  end
...
defmodule GenDAP.Requests.RestartFrameResponse do
  @moduledoc """
  A response to the restartFrame request
  ...
  * type: Message type.
  ...
  @derive JasonV.Encoder
  typedstruct do
    @typedoc "A type defining DAP request restartFrame response"
