# codegen: do not edit
defmodule GenDAP.Requests.RestartRequest do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request restart"

    field(:seq, integer(), enforce: true)
    field(:type, String.t(), default: "request")
    field(:command, String.t(), default: "restart")
    field(:arguments, GenDAP.Structures.RestartArguments.t())
  end
...
defmodule GenDAP.Requests.RestartResponse do
  @moduledoc """
  A response to the restart request
  ...
  * type: Message type.
  ...
  @derive JasonV.Encoder
  typedstruct do
    @typedoc "A type defining DAP request restart response"
