# codegen: do not edit
defmodule GenDAP.Requests.VariablesRequest do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request variables"

    field(:seq, integer(), enforce: true)
    field(:type, String.t(), default: "request")
    field(:command, String.t(), default: "variables")
    field(:arguments, GenDAP.Structures.VariablesArguments.t(), enforce: true)
  end
...
defmodule GenDAP.Requests.VariablesResponse do
  @moduledoc """
  ...
  * type: Message type.
  ...
  @derive JasonV.Encoder
  typedstruct do
    @typedoc "A type defining DAP request variables response"
    ...
    field(:command, String.t(), default: "variables")
    field(:body, %{required(:variables) => list(GenDAP.Structures.Variable.t())}, enforce: true)
  end
  ...
  def schematic() do
    schema(__MODULE__, %{
      ...
      :body =>
        map(%{
          {"variables", :variables} => list(GenDAP.Structures.Variable.schematic())
        })
    })
  end
end
