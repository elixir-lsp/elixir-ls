# codegen: do not edit
defmodule GenDAP.Requests.SetDataBreakpointsRequest do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    ...
    field :arguments, GenDAP.Structures.SetDataBreakpointsArguments.t(), enforce: true
  end
...
defmodule GenDAP.Requests.SetDataBreakpointsResponse do
  @moduledoc """
