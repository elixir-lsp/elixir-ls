# codegen: do not edit
defmodule GenDAP.Requests.CompletionsRequest do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request completions"

    field :seq, integer(), enforce: true
    field :type, String.t(), default: "request"
    field :command, String.t(), default: "completions"
    field :arguments, GenDAP.Structures.CompletionsArguments.t(), enforce: true
  end
...
defmodule GenDAP.Requests.CompletionsResponse do
  @moduledoc """
  ...
  * type: Message type.
  ...
  @derive JasonV.Encoder
  typedstruct do
    @typedoc "A type defining DAP request completions response"
    ...
    field :command, String.t(), default: "completions"
    field :body, %{required(:targets) => list(GenDAP.Structures.CompletionItem.t())}, enforce: true
  end
  ...
  def schematic() do
    schema(__MODULE__, %{
      ...
      :command => "completions",
      :body => map(%{
        {"targets", :targets} => list(GenDAP.Structures.CompletionItem.schematic())
      })
    })
  end
end
