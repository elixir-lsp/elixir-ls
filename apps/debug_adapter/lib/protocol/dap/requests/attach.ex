# codegen: do not edit
defmodule GenDAP.Requests.AttachRequest do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request attach"

    field(:seq, integer(), enforce: true)
    field(:type, String.t(), default: "request")
    field(:command, String.t(), default: "attach")
    field(:arguments, GenDAP.Structures.AttachRequestArguments.t(), enforce: true)
  end
...
defmodule GenDAP.Requests.AttachResponse do
  @moduledoc """
  A response to the attach request
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request attach response"
