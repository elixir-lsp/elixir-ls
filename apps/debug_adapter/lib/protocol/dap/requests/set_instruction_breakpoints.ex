# codegen: do not edit
defmodule GenDAP.Requests.SetInstructionBreakpointsRequest do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request setInstructionBreakpoints"

    field :seq, integer(), enforce: true
    field :type, String.t(), default: "request"
    field :command, String.t(), default: "setInstructionBreakpoints"
    field :arguments, GenDAP.Structures.SetInstructionBreakpointsArguments.t(), enforce: true
  end
...
defmodule GenDAP.Requests.SetInstructionBreakpointsResponse do
  @moduledoc """
  ...
  * type: Message type.
  ...
  @derive JasonV.Encoder
  typedstruct do
    @typedoc "A type defining DAP request setInstructionBreakpoints response"
    ...
    field :command, String.t(), default: "setInstructionBreakpoints"
    field :body, %{required(:breakpoints) => list(GenDAP.Structures.Breakpoint.t())}, enforce: true
  end
  ...
  def schematic() do
    schema(__MODULE__, %{
      ...
      :command => "setInstructionBreakpoints",
      :body => map(%{
        {"breakpoints", :breakpoints} => list(GenDAP.Structures.Breakpoint.schematic())
      })
    })
  end
end
