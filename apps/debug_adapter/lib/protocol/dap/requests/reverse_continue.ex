# codegen: do not edit
defmodule GenDAP.Requests.ReverseContinueRequest do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request reverseContinue"

    field :seq, integer(), enforce: true
    field :type, String.t(), default: "request"
    field :command, String.t(), default: "reverseContinue"
    field :arguments, GenDAP.Structures.ReverseContinueArguments.t(), enforce: true
  end
...
defmodule GenDAP.Requests.ReverseContinueResponse do
  @moduledoc """
  A response to the reverseContinue request
  ...
  * type: Message type.
  ...
  @derive JasonV.Encoder
  typedstruct do
    @typedoc "A type defining DAP request reverseContinue response"
