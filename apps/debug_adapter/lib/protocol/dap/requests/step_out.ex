# codegen: do not edit
defmodule GenDAP.Requests.StepOutRequest do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request stepOut"

    field(:seq, integer(), enforce: true)
    field(:type, String.t(), default: "request")
    field(:command, String.t(), default: "stepOut")
    field(:arguments, GenDAP.Structures.StepOutArguments.t(), enforce: true)
  end
...
defmodule GenDAP.Requests.StepOutResponse do
  @moduledoc """
  A response to the stepOut request
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request stepOut response"
