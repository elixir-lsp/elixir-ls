# codegen: do not edit
defmodule GenDAP.Requests.ExceptionInfoRequest do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request exceptionInfo"

    field :seq, integer(), enforce: true
    field :type, String.t(), default: "request"
    field :command, String.t(), default: "exceptionInfo"
    field :arguments, GenDAP.Structures.ExceptionInfoArguments.t(), enforce: true
  end
...
defmodule GenDAP.Requests.ExceptionInfoResponse do
  @moduledoc """
  ...
  * type: Message type.
  ...
  @derive JasonV.Encoder
  typedstruct do
    @typedoc "A type defining DAP request exceptionInfo response"
    ...
    field :command, String.t(), default: "exceptionInfo"
    field :body, %{optional(:description) => String.t(), optional(:details) => GenDAP.Structures.ExceptionDetails.t(), required(:exception_id) => String.t(), required(:break_mode) => GenDAP.Enumerations.ExceptionBreakMode.t()}, enforce: true
  end
  ...
  def schematic() do
    schema(__MODULE__, %{
      ...
      :body => map(%{
        ...
        optional({"details", :details}) => GenDAP.Structures.ExceptionDetails.schematic(),
        {"exceptionId", :exception_id} => str(),
