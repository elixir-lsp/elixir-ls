# codegen: do not edit
defmodule GenDAP.Requests.StepBackRequest do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request stepBack"

    field(:seq, integer(), enforce: true)
    field(:type, String.t(), default: "request")
    field(:command, String.t(), default: "stepBack")
    field(:arguments, GenDAP.Structures.StepBackArguments.t(), enforce: true)
  end
...
defmodule GenDAP.Requests.StepBackResponse do
  @moduledoc """
  A response to the stepBack request
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request stepBack response"
