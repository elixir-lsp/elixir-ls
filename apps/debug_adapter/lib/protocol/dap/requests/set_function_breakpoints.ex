# codegen: do not edit
defmodule GenDAP.Requests.SetFunctionBreakpointsRequest do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request setFunctionBreakpoints"

    field :seq, integer(), enforce: true
    field :type, String.t(), default: "request"
    field :command, String.t(), default: "setFunctionBreakpoints"
    field :arguments, GenDAP.Structures.SetFunctionBreakpointsArguments.t(), enforce: true
  end
...
defmodule GenDAP.Requests.SetFunctionBreakpointsResponse do
  @moduledoc """
  ...
  * type: Message type.
  ...
  @derive JasonV.Encoder
  typedstruct do
    @typedoc "A type defining DAP request setFunctionBreakpoints response"
