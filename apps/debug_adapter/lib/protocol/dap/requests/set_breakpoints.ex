# codegen: do not edit
defmodule GenDAP.Requests.SetBreakpointsRequest do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request setBreakpoints"

    field :seq, integer(), enforce: true
    field :type, String.t(), default: "request"
    field :command, String.t(), default: "setBreakpoints"
    field :arguments, GenDAP.Structures.SetBreakpointsArguments.t(), enforce: true
  end
...
defmodule GenDAP.Requests.SetBreakpointsResponse do
  @moduledoc """
  ...
  * type: Message type.
  ...
  @derive JasonV.Encoder
  typedstruct do
    @typedoc "A type defining DAP request setBreakpoints response"
