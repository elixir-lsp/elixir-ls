# codegen: do not edit
defmodule GenDAP.Requests.ConfigurationDoneRequest do
  @moduledoc """
  ...
  * type: Message type.
  ...
  typedstruct do
    @typedoc "A type defining DAP request configurationDone"

    field :seq, integer(), enforce: true
    field :type, String.t(), default: "request"
    field :command, String.t(), default: "configurationDone"
    field :arguments, GenDAP.Structures.ConfigurationDoneArguments.t()
  end
...
defmodule GenDAP.Requests.ConfigurationDoneResponse do
  @moduledoc """
  A response to the configurationDone request
  ...
  * type: Message type.
  ...
  @derive JasonV.Encoder
  typedstruct do
    @typedoc "A type defining DAP request configurationDone response"
