# codegen: do not edit
defmodule GenDAP.Structures.InitializeResponse do
  @moduledoc """
  ...
  * body: The capabilities of this debug adapter.
  ...
  * request_seq: Sequence number of the corresponding request.
  ...
  def schematic() do
    schema(__MODULE__, %{
      optional({"body", :body}) => GenDAP.Structures.Capabilities.schematic(),
      {"command", :command} => str(),
