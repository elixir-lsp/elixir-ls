# codegen: do not edit
defmodule GenDAP.Structures.SetVariableResponse do
  @moduledoc """
  ...
  * request_seq: Sequence number of the corresponding request.
  ...
  typedstruct do
    field :body, %{type: String.t(), value: String.t(), variables_reference: integer(), memory_reference: String.t(), named_variables: integer(), indexed_variables: integer(), value_location_reference: integer()}, enforce: true
