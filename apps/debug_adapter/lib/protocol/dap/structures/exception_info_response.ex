# codegen: do not edit
defmodule GenDAP.Structures.ExceptionInfoResponse do
  @moduledoc """
  ...
  * request_seq: Sequence number of the corresponding request.
  ...
  typedstruct do
    field :body, %{description: String.t(), details: GenDAP.Structures.ExceptionDetails.t(), exception_id: String.t(), break_mode: GenDAP.Enumerations.ExceptionBreakMode.t()}, enforce: true
