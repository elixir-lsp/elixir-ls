...
defmodule GenDAP.Events.ProcessEvent do
  ...
  * type: Message type.
  ...
  typedstruct do
    ...
    field :body, %{required(:name) => String.t(), optional(:system_process_id) => integer(), optional(:is_local_process) => boolean(), optional(:start_method) => String.t(), optional(:pointer_size) => integer()}, enforce: true
  end
