defmodule ElixirLS.LanguageServer.ParallelCompiler do
  @moduledoc """
  ...
  defp print_failure(%ElixirLS.LanguageServer.SourceFile{path: path}, {:failure, kind, reason, stacktrace}) do
