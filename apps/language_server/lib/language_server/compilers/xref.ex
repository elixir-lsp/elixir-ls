defmodule ElixirLS.LanguageServer.Compilers.Xref do
  use Mix.Task

  alias ElixirLS.LanguageServer.Compilers.Elixir, as: E
  import ElixirLS.LanguageServer.Compilers.Elixir, only: [read_manifest: 2, source: 1, source: 2, module: 1]
