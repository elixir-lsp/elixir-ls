defmodule ElixirLS.Debugger.ServerTest do
  ...
  test "basic debugging", %{server: server} do
    in_fixture __DIR__, "mix_project", fn ->
      ...
      Server.receive_packet(server, launch_req(2, %{"request" => "launch", "type" => "mix_task", "task" => "test", "projectDir" => File.cwd!()}))
      ...
      assert_receive response(_, 8, "variables", %{"variables" =>
            [%{"name" => "Vx@1", "type" => "integer", "value" => "2", "variablesReference" => 0}]})
